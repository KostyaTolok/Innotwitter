"""
Django settings for Innotwitter project.
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'Innotwitter.backends.JWTAuthentication',
    ),
}

ROOT_URLCONF = 'Innotwitter.urls'
...
WSGI_APPLICATION = 'Innotwitter.wsgi.application'
